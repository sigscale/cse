%%% cse_slp_postpaid_diameter_mms_fsm.erl
%%% vim: ts=3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%----------------------------------------------------------------------
%%  The cse_slp_postpaid_diameter_mms_fsm gen_statem callbacks
%%----------------------------------------------------------------------
...
%% @hidden
service_info(#'3gpp_rf_Service-Information'{'MMS-Information' = MMS,
