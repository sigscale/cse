...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
-module(cse_statistics_server).
-copyright('Copyright (c) 2016 - 2022 SigScale Global Inc.').

-behaviour(gen_server).

%% export the cse_statistics_server API
-export([start_link/0]).
...
start_link() ->
	case gen_server:start_link({local, cse_statistics},
			?MODULE, [[]], []) of
		{ok, Child} ->
			{ok, Child};
		{error, Reason} ->
...
%%----------------------------------------------------------------------
%%  The cse_statistics_server gen_server call backs
%%----------------------------------------------------------------------
